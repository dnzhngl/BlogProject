...
namespace Blog.Services.Utilities
{
    public static class Messages
    {
        ...
        public static class Category
        {
            ...
            public static string Exist(string categoryName)
            {
                return $"Sistemde {categoryName} adlı bir kategori bulunmaktadır.";
            }
        }
        ...
        public static class Article
        {
            ...
            public static string Exist(string articleTitle)
            {
                return $"Sistemde {articleTitle} adlı bir makale bulunmaktadır.";
            }
        }
    }
}
