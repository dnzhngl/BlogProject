...
namespace Blog.Mvc.Areas.Admin.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        #region Before BaseController inheritance instead of Controller inheritance
        ...
        public async Task<IActionResult> Update(ArticleUpdateViewModel articleUpdateViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var defaultThumbnail = "defaultThumbnail.jpg";
                    ...
                    articleUpdateViewModel.Thumbnail = uploadedImageResult.ResultStatus == ResultStatus.Success ? uploadedImageResult.Data.PictureName : defaultThumbnail;

                    if (oldThumbnail != defaultThumbnail)
                    {
                ...
                if (result.ResultStatus == ResultStatus.Success)
                {
                    ...
                    {
                        ImageHelper.Delete(oldThumbnail, PictureType.Post);
                    }
                    //TempData.Add("SuccessMeesage", result.Message);
                    _toastNotification.AddSuccessToastMessage(result.Message, new ToastrOptions
                    {
                        Title = "Başarılı İşlem!"
                    });
        ...
        public async Task<JsonResult> Delete(int articleId)
        {
            ...
            var articleResult = JsonSerializer.Serialize(result); // article result bu sayede front end tarafında da kullanabileceğiz.
